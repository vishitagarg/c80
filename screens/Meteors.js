...
export default class MeteorScreen extends Component {
    ...
    getMeteors =()=>{
        axios
            .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=KC0hhnHhg3IY37EihbpJ5rIGVdMJtlSaXGMBISoX")
            .then(response=>{
                this.setState({
...
renderItem=({item})=> {
    ...
    return(
            <View>
              ...
              <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}>Maxi Diameter (KM) - {item.estimated_diameter.kilometers.estimated_diameter_max}</Text>
